...
from nextbillion_sdk.types.optimization import (
...
class TestV2:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_create_request(self, client: NextbillionSDK) -> None:
        v2 = client.optimization.v2.create_request(
            key="key=API_KEY",
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_create_request_with_all_params(self, client: NextbillionSDK) -> None:
        v2 = client.optimization.v2.create_request(
            key="key=API_KEY",
            locations={
                "location": ["string"],
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_create_request(self, client: NextbillionSDK) -> None:
        response = client.optimization.v2.with_raw_response.create_request(
            key="key=API_KEY",
            locations={"location": ["string"]},
            vehicles=[
                {
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_create_request(self, client: NextbillionSDK) -> None:
        with client.optimization.v2.with_streaming_response.create_request(
            key="key=API_KEY",
            locations={"location": ["string"]},
            vehicles=[
                {
...
class TestAsyncV2:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_create_request(self, async_client: AsyncNextbillionSDK) -> None:
        v2 = await async_client.optimization.v2.create_request(
            key="key=API_KEY",
            locations={"location": ["string"]},
            vehicles=[
                {
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_create_request_with_all_params(self, async_client: AsyncNextbillionSDK) -> None:
        v2 = await async_client.optimization.v2.create_request(
            key="key=API_KEY",
            locations={
                "location": ["string"],
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_create_request(self, async_client: AsyncNextbillionSDK) -> None:
        response = await async_client.optimization.v2.with_raw_response.create_request(
            key="key=API_KEY",
            locations={"location": ["string"]},
            vehicles=[
                {
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_create_request(self, async_client: AsyncNextbillionSDK) -> None:
        async with async_client.optimization.v2.with_streaming_response.create_request(
            key="key=API_KEY",
            locations={"location": ["string"]},
            vehicles=[
                {
