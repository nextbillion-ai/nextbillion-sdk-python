...
from ..types import autosuggest_suggest_params
...
from ..types.autosuggest_suggest_response import AutosuggestSuggestResponse

__all__ = ["AutosuggestResource", "AsyncAutosuggestResource"]


class AutosuggestResource(SyncAPIResource):
    @cached_property
    def with_raw_response(self) -> AutosuggestResourceWithRawResponse:
        """
        ...
        """
        return AutosuggestResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AutosuggestResourceWithStreamingResponse:
        """
        ...
        """
        return AutosuggestResourceWithStreamingResponse(self)
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    autosuggest_suggest_params.AutosuggestSuggestParams,
                ),
            ),
            cast_to=AutosuggestSuggestResponse,
        )


class AsyncAutosuggestResource(AsyncAPIResource):
    @cached_property
    def with_raw_response(self) -> AsyncAutosuggestResourceWithRawResponse:
        """
        This property can be used as a prefix for any HTTP method call to return
        the raw response object instead of the parsed content.
        ...
        For more information, see https://www.github.com/stainless-sdks/nextbillion-sdk-python#accessing-raw-response-data-eg-headers
        """
        return AsyncAutosuggestResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncAutosuggestResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.

        For more information, see https://www.github.com/stainless-sdks/nextbillion-sdk-python#with_streaming_response
        """
        return AsyncAutosuggestResourceWithStreamingResponse(self)
...
class AutosuggestResourceWithRawResponse:
    def __init__(self, autosuggest: AutosuggestResource) -> None:
...
class AsyncAutosuggestResourceWithRawResponse:
    def __init__(self, autosuggest: AsyncAutosuggestResource) -> None:
        self._autosuggest = autosuggest
...
class AutosuggestResourceWithStreamingResponse:
    def __init__(self, autosuggest: AutosuggestResource) -> None:
        self._autosuggest = autosuggest
...
class AsyncAutosuggestResourceWithStreamingResponse:
    def __init__(self, autosuggest: AsyncAutosuggestResource) -> None:
        self._autosuggest = autosuggest
