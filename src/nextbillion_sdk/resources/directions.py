...
class DirectionsResource(SyncAPIResource):
    ...
    def compute_route(
        ...
        *,
        ...
        approaches: str | NotGiven = NOT_GIVEN,
        avoid: Literal[
            "toll",
            "ferry",
            "highway",
        ...
        drive_time_limits: str | NotGiven = NOT_GIVEN,
        emission_class: Literal[
            "euro0", "euro1", "euro2", "euro3", "euro4", "euro5", "euro6", "euro7", "euro8", "euro9"
        ]
        | NotGiven = NOT_GIVEN,
        exclude: Literal[
        ...
        Args:
          ...
          alternatives: When true the API will return alternate routes.
          ...
          cross_border: Requires option=flexible.
          ...
          departure_time: Requires option=flexible.
          ...
          drive_time_limits: Requires option=flexible.
          ...
          emission_class: Requires option=flexible.
          ...
          exclude: Requires option=flexible.
          ...
          geometry: Sets the output format of the route geometry in the response.
          ...
          hazmat_type: Requires option=flexible.
          ...
          mode: Set the driving mode the service should use to determine a route. In "car" mode,
          ...
          option: The option parameter specifies the version of the directions service to use.
          ...
          overview: Specify the verbosity of route geometry.
          ...
          rest_times: Requires option=flexible.
          ...
          road_info: Requires option=flexible.
          ...
          route_type: Requires option=flexible.

              Set the route type that needs to be returned.

          steps: Set this to true to receive additional details about the routes and each of its
              legs (details of geometry, start & end locations) in the response.

          truck_axle_load: Requires option=flexible.
          ...
          truck_size: Requires option=flexible.
          ...
          truck_weight: Requires option=flexible.
          ...
          turn_angle_range: Requires option=flexible.
          ...
          waypoints: Pipe-separated list of coordinate pairs
            ...
            body=maybe_transform(
                {
                    ...
                    "drive_time_limits": drive_time_limits,
                    ...
                    "turn_angle_range": turn_angle_range,
                    "waypoints": waypoints,
                },
