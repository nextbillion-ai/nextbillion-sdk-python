...
class DiscoverResource(SyncAPIResource):
    @cached_property
    def with_raw_response(self) -> DiscoverResourceWithRawResponse:
        """
    ...
    @cached_property
    def with_streaming_response(self) -> DiscoverResourceWithStreamingResponse:
        """
...
class AsyncDiscoverResource(AsyncAPIResource):
    @cached_property
    def with_raw_response(self) -> AsyncDiscoverResourceWithRawResponse:
        """
        This property can be used as a prefix for any HTTP method call to return
        the raw response object instead of the parsed content.
    ...
    @cached_property
    def with_streaming_response(self) -> AsyncDiscoverResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.
...
class DiscoverResourceWithRawResponse:
...
class AsyncDiscoverResourceWithRawResponse:
...
class DiscoverResourceWithStreamingResponse:
    def __init__(self, discover: DiscoverResource) -> None:
        self._discover = discover
...
class AsyncDiscoverResourceWithStreamingResponse:
    def __init__(self, discover: AsyncDiscoverResource) -> None:
        self._discover = discover
